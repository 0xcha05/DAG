  ...
  return (
    <div className="w-full h-full flex flex-col bg-gray-50">
      <div className="p-4 border-b border-gray-200 flex-shrink-0">
        <h2 className="text-lg font-bold text-gray-800">Edit History</h2>
      </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-2 flex-1">
                      ...
                      <ChevronIcon className="w-4 h-4 text-gray-400 flex-shrink-0" />
                    </div>
                  </div>
                </div>
                      ...
                      {group.systemRecalcs.map((recalc, idx) => (
                        ...
                        >
                          <div className="flex items-start gap-2">
                            <Cpu className="w-3.5 h-3.5 text-green-600 mt-0.5 flex-shrink-0" />
                            <div className="flex-1 min-w-0 text-sm">
                              ...
                              {recalc.formula && (
                                <div className="mt-1 text-xs font-mono bg-gray-100 text-gray-700 px-2 py-1 rounded break-all">
                                  {recalc.formula}
                                </div>
                              )}
                            </div>
